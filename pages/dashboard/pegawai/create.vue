    ...
    <div class="mb-5 antialiased">
      <div class="flex justify-between">
        <div class="flex-col my-auto">
          ...
          <p>Menu untuk menambah pegawai baru</p>
        </div>
                ...
                <div class="col-span-1">
                  ...
                  <div class="mt-1 flex-col">
                    <input
                      ...
                      type="password"
                      :class="{ 'border-red-600' : form.submitted && $v.form.password.$error }"
                      name="password"
                      @blur="$v.form.password.$touch()"
                      @focus="$v.form.password.$touch()"
                    >
                    <span v-if="form.submitted && !$v.form.password.required" class="text-xs text-red-500">
                      Password tidak boleh kosong
                    </span>
                    <span v-else-if="form.submitted && !$v.form.password.minLength" class="text-xs text-red-500">
                      Password kurang dari 8 karakter
                    </span>
                    <span v-else-if="form.submitted && !$v.form.password.maxLength" class="text-xs text-red-500">
                ...
                <div class="col-span-1">
                  ...
                  <div class="mt-1 flex-col">
                    <input
                      ...
                      type="password"
                      :class="{ 'border-red-600' : form.submitted && $v.form.confirmPassword.$error }"
                      @blur="$v.form.confirmPassword.$touch()"
                      @focus="$v.form.confirmPassword.$touch()"
                    >
                    <span v-if="form.submitted && !$v.form.confirmPassword.required" class="text-xs text-red-500">
                      Konfirmasi password tidak boleh kosong
                    </span>
                    <span v-else-if="form.submitted && !$v.form.confirmPassword.minLength" class="text-xs text-red-500">
                      Konfirmasi password kurang dari 8 karakter
                    </span>
                    <span v-else-if="form.submitted && !$v.form.confirmPassword.sameAs" class="text-xs text-red-500">
                      Konfirmasi password tidak sama
                    </span>
                    <span v-else-if="form.submitted && !$v.form.confirmPassword.maxLength" class="text-xs text-red-500">
...
export default {
  ...
  methods: {
    ...
    back () {
      this.$router.push('/dashboard/pegawai')
    },
    createEmployeeAPI () {
